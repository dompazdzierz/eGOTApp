...
class SectionPropose extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
    ...
    render() {
        ...
        return(
            <SegmentContainer headerContent="Zaproponuj odcinek" iconName='paper plane'
            ...
            <Form loading={!(this.state.locationsData && this.state.mountainRangesData)}>
                ...
                <Form.Field style={{paddingLeft: '220px'}} inline>
                    <Button
                        primary
                        type="submit"
                        onClick={this.onSubmit}
                        content={'Zaproponuj odcinek'}
                    />
                    <Label
                        style={labelStyle}
                        pointing='left'
                        ...
                        content='Pomyślnie zaproponowano odcinek&nbsp;&nbsp;&nbsp;&nbsp;'
                        basic
                    />
                </Form.Field>
