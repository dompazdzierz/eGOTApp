...
namespace eGOTBackend.Migrations
{
    ...
    [Migration("20200120025658_rename_mountain_system_fk")]
    partial class rename_mountain_system_fk
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eGOTBackend.Models.MountainRange", b =>
                {
                    b.HasOne("eGOTBackend.Models.MountainSystem", "MountainSystemNavigation")
                        .WithMany("MountainRanges")
                        .HasForeignKey("MountainSystem")
            ...
            modelBuilder.Entity("eGOTBackend.Models.Section", b =>
                {
                    b.HasOne("eGOTBackend.Models.Location", "EndLocationNavigation")
                        .WithMany("SectionEndLocationNavigation")
                        .HasForeignKey("EndLocation")
                        .HasConstraintName("FKSection74604")
                        .IsRequired();

                    b.HasOne("eGOTBackend.Models.MountainRange", "MountainRangeNavigation")
                        .WithMany("Section")
                        .HasForeignKey("MountainRange")
                        .HasConstraintName("FKSection521241")
                        .IsRequired();

                    b.HasOne("eGOTBackend.Models.Location", "StartLocationNavigation")
